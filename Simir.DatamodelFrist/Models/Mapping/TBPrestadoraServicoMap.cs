...
{
    public class TBPrestadoraServicoMap : EntityTypeConfiguration<TBPrestadoraServico>
    {
        public TBPrestadoraServicoMap()
        {
            // Primary Key
            this.HasKey(t => t.PrestadoraServicosID);
            ...
            this.ToTable("TBPrestadoraServicos");
            ...
            // Relationships
            this.HasRequired(t => t.TBEndereco)
                .WithMany(t => t.TBPrestadoraServicos)
